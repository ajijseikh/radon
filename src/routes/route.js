...
const UserDocController = require("../controllers/OrderDocController.js")
...
// router.post("/createUser",commonMW.mid1,UserDocController.createUsers);
router.post("/createOrder",OrderDocController.createOrder);
